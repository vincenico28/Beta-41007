...
import { Bell, Check, Loader2, Info, AlertTriangle, CheckCircle, XCircle, Megaphone, Volume2, Paperclip } from 'lucide-react'
                ...
                >
                  ...
                  <div className="flex-1 space-y-1">
                    ...
                    <div className="flex items-center justify-between gap-2 mt-1">
                      ...
                      {n.attachment_url && (
                        <span className="inline-flex items-center gap-0.5 text-[10px] font-medium text-primary bg-primary/10 px-1.5 py-0.2 rounded">
                          <Paperclip className="size-2.5" /> File
                        </span>
                      )}
                    </div>
                  </div>
